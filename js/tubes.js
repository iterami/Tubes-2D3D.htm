...
function setmode(newmode){
    ...
    /* main menu mode */
        ...
        get('page').innerHTML = '<div style=display:inline-block;text-align:left;vertical-align:top><div class=c><a href=/><b>Tubes</b></a></div><hr><div class=c style=color:#f00>SEIZURE WARNING!<br>FLASHING LIGHTS!</div><hr><div class=c><a onclick=setmode(1)>Make Mama Sick</a></div></div><div style="border-left:8px solid #222;display:inline-block;text-align:left"><div class=c><input disabled size=3 style=border:0 type=text value=ESC>Main Menu<br><input id=movement-keys maxlength=2 size=3 type=text value='
